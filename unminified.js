(this.wordle = this.wordle || {}),
    (this.wordle.bundle = (function (e) {
        ...
        var Pa = "IN_PROGRESS",
            ...
            Ba = "FAIL",
            Fa = [
                ["Um I am literally so impressed I have no words except to continue clapping until you've encored yourself out."],
                ["Truly, a virtuoso of words for our time!", "That was a horns to box kind of moment!"],
                ["We can't all be Paganini but you're up there!", "You're the Ira to Musicl's George"],
                ["Pretty good, although as my teacher likes to say 'slide til you hit the note...then stop sliding'", "With more feeling, next time!", "Better hit the practice room."],
                ["The band didn't quite make that corner.", "You might be a tad out of tune.", "Consider carving a new reed before next time."],
                ["You considered breaking a leg there, I think.", "You know there are more letters than A-G, right?"],
            ];
